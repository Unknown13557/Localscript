...
local CatchPlayer = Slots[19]
CatchPlayer.Label.Text = "TP Tracker"
...
layoutCatch.HorizontalAlignment = Enum.HorizontalAlignment.Center
layoutCatch.Padding = UDim.new(0,4)

local tpBtn = Instance.new("TextButton")
tpBtn.Parent = rowCatch
tpBtn.Size = UDim2.fromOffset(80, 28)
tpBtn.Text = "TP Marker"
...
tpBtn.MouseButton1Click:Connect(function()
	...
	-- Dịch chuyển thẳng chính xác đến vị trí marker (không cộng thêm chiều cao)
